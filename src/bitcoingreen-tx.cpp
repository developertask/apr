...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("APR coin Core aprcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  aprcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoin green transaction") + "\n" +
                               "  aprcoin-tx [options] -create [commands]   " + _("Create hex-encoded bitcoin green transaction") + "\n" +
                               "\n";
